...
const dojosData = [
  {
    ...
    description: "Create interactive art, captivating audiences while fostering community collaboration.",
  ...
  },
  {
    id: 11,
    title: "Musicians",
    description: "Create a collaborative platform for music production, library management, and streaming.",
